...
<body>
  <main class="bg-[#FAFAFA] max-w-[640px] mx-auto min-h-screen relative flex flex-col has-[#CTA-nav]:pb-[120px] has-[#Bottom-nav]:pb-[120px]">
    <div id="Top-nav" class="flex items-center justify-between px-4 pt-5 absolute top-0 z-40 w-full">
      <a href="{{url()->previous()}}">
    ...
    <section id="Thumbnail" class="relative z-20">
      <div class="swiper h-fit">
        <div class="swiper-wrapper w-full h-fit">
          ...
          <div class="swiper-slide !w-[310px] !h-[350px] flex shrink-0 overflow-hidden">
            <img src="{{asset('assets/images/thumbnails/th-details-3.png')}}" class="object-cover w-full h-full" alt="thumbnail">
          </div>
        </div>
      </div>
      <div class="px-4 flex justify-between items-center transform translate-y-1/2 absolute bottom-0 z-50 w-full">
        @if($carStore->is_open)
    ...
    <section id="details" class="flex flex-col gap-5 px-4 mt-[33px] relative z-5">
      ...
      <div id="Menus" class="flex flex-col gap-5">
        ...
        <div class="tabs-contents">
          ...
          <div id="reviews-tab" class="tabcontent hidden">
          ...
          <div id="contact-tab" class="tabcontent flex">
            <div class="flex flex-col gap-5">
